...
export class AuthService {
  private baseUrl: string = 'https://localhost:7201/api/Customer/';
  ...
  getNameFromToken() {
    if (this.userPayload) return this.userPayload.unique_name[0];
  }

  getIdFromToken() {
    if (this.userPayload) return this.userPayload.unique_name[1];
  }
